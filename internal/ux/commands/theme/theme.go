...
// Themes is the list of all built-in themes.
var Themes = []uxtypes.Theme{ //nolint:gochecknoglobals
	Default,
	dracula,
	gruvbox,
	tokyo,
...
var Default = uxtypes.Theme{ //nolint:gochecknoglobals
	Name:          "default",
...
var dracula = uxtypes.Theme{ //nolint:gochecknoglobals
	Name:          "dracula",
...
var gruvbox = uxtypes.Theme{ //nolint:gochecknoglobals
	Name:          "gruvbox",
...
var tokyo = uxtypes.Theme{ //nolint:gochecknoglobals
	Name:          "tokyo-night",
...
var solarized = uxtypes.Theme{ //nolint:gochecknoglobals
	Name:          "solarized",
...
var nord = uxtypes.Theme{ //nolint:gochecknoglobals
	Name:          "nord",
...
var catppuccin = uxtypes.Theme{ //nolint:gochecknoglobals
	Name:          "catppuccin",
...
// Names returns the names of all available themes.
func Names() []string {
...
// Find returns the theme with the given name, or nil.
func Find(name string) *uxtypes.Theme {
	for i := range Themes {
...
// Next returns the theme after the current one (cycling).
func Next(current string) uxtypes.Theme {
	for i, t := range Themes {
		if t.Name == current {
