...
func AllActions() iter.Seq[ifaces.Action] {
	return slices.Values([]ifaces.Action{
		...
		actions.NewDeleteWorktree(),
		actions.NewRepairWorktree(),
		actions.NewPruneWorktrees(),
		actions.NewUnlockWorktree(),
		actions.NewLockWorktree(),
		actions.NewAddWorktree(),
		actions.NewMoveWorktree(),
		actions.NewStashWorktreeDirty(),
